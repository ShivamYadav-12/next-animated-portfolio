    ...
    <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
      <div className="h-full flex flex-col lg:flex-row  px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48  ">
        ...
        <div className="h-1/2 flex flex-col gap-8 justify-center items-center lg:h-full lg:w-1/2">
          ...
          <p className="md:text-xl">Welcome to my digital canvas where innovation and creativity coverge. with keen eye for aesthethics and mastery of code ,my portfolio contain diverse collections of my projects that reflect my correctness to excellence</p>
